module.exports = {
    config: {
        name: "randomImage",
        aliases: ["randompic", "imagepic"],
        version: "1.0",
        author: "OtinXSandip",
        countDown: 5,
        role: 2, // You can modify this if your admin role is different
        shortDescription: "Sends a random image",
        longDescription: "Sends a random image from a curated list",
        category: "fun",
        guide: "{pn}"
    },

    onStart: async function ({ message, event }) {
        // Check if the user is an admin (assuming role 1 or 2 means admin)
        if (message.sender.id !== event.senderID && !message.isAdmin) {
        ...
        // Send the random image with a fun message
        message.send({
            body: "Here is a random image for you! Enjoy! 📸😄", 
