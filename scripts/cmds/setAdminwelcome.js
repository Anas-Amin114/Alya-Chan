...
async function saveChanges(message, event, threadID, senderID, threadsData, getLang) {
  ...
  // Send a more respectful, kingly message to the admin
  message.reply(getLang("addedFile", attachments.length) + " 👑 Mighty one, your royal welcome message is now even more magnificent with these glorious attachments! 🌟 The group shall feel your presence and wisdom! 🥳🎉");
}
